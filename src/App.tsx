...
const projects = [
  ...
  {
    name: "Toiletime",
    description: "离开工位时添加一条说明，优雅地管理你的碎片时间。",
...
export default function App() {
  return (
    <div className="min-h-screen relative font-sans selection:bg-rose-100 selection:text-rose-900">
      <ParticleBackground />
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 py-20 md:py-32">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-md border border-white/40 shadow-sm mb-8 text-sm text-gray-600 font-medium tracking-wide">
          ...
          <p className="text-lg md:text-xl text-gray-500 max-w-2xl leading-relaxed font-light mb-10 mx-auto md:mx-0">
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start">
            <a
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-full bg-gray-900 text-white hover:bg-gray-800 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5"
            >
              <Github size={18} />
              <span>GitHub</span>
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-6 py-3 rounded-full bg-white/80 backdrop-blur-md text-gray-700 border border-gray-200 hover:border-rose-200 hover:text-rose-600 transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-0.5"
            >
              <BookOpen size={18} />
              <span>Blog</span>
            </a>
        ...
        <motion.footer
          ...
          className="mt-32 pt-8 border-t border-gray-200/50 text-center text-gray-400 text-sm flex flex-col items-center gap-2"
        >
      ...
      <div className="fixed top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-rose-100/30 blur-[120px] pointer-events-none z-0" />
      <div className="fixed bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-orange-100/30 blur-[120px] pointer-events-none z-0" />
    </div>
  );
}
